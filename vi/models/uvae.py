...
from vi.models.classifier import Classifier, LinearLogRegClassifier
from vi.models.modules import Decoder, Encoder
from vi.models.utils import broadcast_labels
from vi.models.vae import VAE
...
class UVAE(VAE):
    ...
    def __init__(self, n_input, n_labels, n_hidden=128, n_latent=10, n_layers=1, dropout_rate=0.1,
                 y_prior=None, logreg_classifier=False,
                 reconstruction_loss="gaussian", labels_groups=None, use_labels_groups=False):
        super(UVAE, self).__init__(n_input, n_hidden=n_hidden, n_latent=n_latent, n_layers=n_layers,
                                    dropout_rate=dropout_rate, reconstruction_loss=reconstruction_loss)
        ...
        self.classification_ratio = torch.nn.Parameter(torch.randn(2, ))
